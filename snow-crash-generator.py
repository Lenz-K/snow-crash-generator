...
QR_CODE_CONTENT = 'https://github.com/Lenz-K/snow-crash-generator'
...
def main():
    ...
    if DO_INCLUDE_QR_CODE:
        qr_img, qr_img_size = create_qr_code()
        # Paste the QR code into the image
        img.paste(qr_img, (X_RESOLUTION - qr_img_size, Y_RESOLUTION - qr_img_size))
    # Save the image
